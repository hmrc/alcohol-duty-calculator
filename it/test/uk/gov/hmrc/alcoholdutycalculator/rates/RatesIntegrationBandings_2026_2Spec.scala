...
class RatesIntegrationBandings_2026_2Spec extends ISpecBase {
  ...
  private lazy val year: Int                            = 2026
  private lazy val startMonthInclusive: Int             = 2 // Feb 26
  ...
  s"rates file for period $ratePeriod must" - {
    ...
    "hold valid data" - {
      ...
      "For band A" - {
        val rate: Option[Double]   = Some(9.96d)
      ...
      "For band B" - {
        val rate: Option[Double]   = Some(22.58d)
      ...
      "For band C" - {
        val rate: Option[Double]   = Some(10.39d)
      ...
      "For band D" - {
        val rate: Option[Double]   = Some(26.61d)
      ...
      "For band E" - {
        val rate: Option[Double]   = Some(30.62d)
      ...
      "For band F" - {
        val rate: Option[Double]   = Some(33.99d)
      ...
      "For band G" - {
        val rate: Option[Double]   = Some(8.58d)
      ...
      "For band H" - {
        val rate: Option[Double]   = Some(19.45d)
      ...
      "For band I" - {
        val rate: Option[Double]   = Some(8.95d)
