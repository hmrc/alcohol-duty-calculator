...
import uk.gov.hmrc.alcoholdutycalculator.models.AlcoholRegime.{Beer, Other, Wine}
    ...
    "respond with 200 status" in {
      ...
      val urlParams =
        s"?ratePeriod=${Json.toJson(YearMonth.of(2023, 5))(RatePeriod.yearMonthFormat).toString()}&rateType=${Json
          ...
          .toJson(Set(Json.toJson[AlcoholRegime](Beer), Json.toJson[AlcoholRegime](Wine), Json.toJson[AlcoholRegime](Other)))
          .toString()}"
