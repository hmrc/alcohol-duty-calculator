...
object CalculateDutyDueByTaxTypeRequestItem {
  implicit val calculateDutyDueByTaxTypeRequestItemFormat: OFormat[CalculateDutyDueByTaxTypeRequestItem] =
    Json.format[CalculateDutyDueByTaxTypeRequestItem]
}
...
object CalculateDutyDueByTaxTypeRequest {
  implicit val calculateDutyDueByTaxTypeRequestFormat: OFormat[CalculateDutyDueByTaxTypeRequest] =
    Json.format[CalculateDutyDueByTaxTypeRequest]
}
